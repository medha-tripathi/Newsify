  ...
  return (
    <>
      ...
      <div className='detailnews'>
        <div className="content"><div className="detailnewstitle">
          <Link to="/"><button><i class="fa-solid fa-left-long fa-lg" style={{ color: "white" }}></i></button></Link><h1> War-crimes warrant for Putin could complicate Ukraine peace</h1></div>
          <div className="imgnpara"><div className="newsimage w3-hover-shadow"><img src="https://th-i.thgim.com/public/incoming/wa08nu/article66690957.ece/alternates/LANDSCAPE_1200/Russia_Ukraine_Putin_Court_Quandary_83075.jpg" alt="" /></div>
            <div className="alltext">
              <div className="newsdesc">
                <p>An international arrest warrant for President Vladimir Putin raises the prospect of the man whose country invaded Ukraine facing justice, but it complicates efforts to end that war in peace talks.
