...
export default function Detail() {
  return (
    <div className='detailnews'>
      <div className="content"><div className="detailnewstitle"><a href="/"><button><i class="fa-solid fa-left-long fa-lg" style={{color: "white"}}></i></button></a><h1> War-crimes warrant for Putin could complicate Ukraine peace</h1></div>
