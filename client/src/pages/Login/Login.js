...
export default function Login() {
  ...
  return (
    ...
    <pre><div className="logintitle w3-animate-zoom">Login To <span>Newsify</span></div></pre> 
        ...
        <Link to="/signup"><button className='btn btn-light nav-sec-link'>Register</button></Link>
      ...
      ><Alert severity="error">Wrong Credential!!!</Alert></Snackbar></>)
            }</>
